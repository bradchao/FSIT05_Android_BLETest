...
//                    }
                    ...
                    UUID uuidServie = UUID.fromString("0000180f-0000-1000-8000-00805f9b34fb");
                    UUID uuidChar = UUID.fromString("00002a19-0000-1000-8000-00805f9b34fb");

                    mClient.notify(deviceMac, uuidServie, uuidChar, new BleNotifyResponse() {
                        @Override
